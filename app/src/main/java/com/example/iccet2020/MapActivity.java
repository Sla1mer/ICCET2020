...
import com.example.iccet2020.models.direction.DirectionFinder;
import com.example.iccet2020.models.direction.DirectionFinderListener;
import com.example.iccet2020.models.direction.Route;
import com.example.iccet2020.Services.FetchAddressIntentService;
import com.example.iccet2020.Connections;
import com.example.iccet2020.Constants;
import com.example.iccet2020.PermissionGPS;
...
public class MapActivity extends AppCompatActivity implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener,
    ...
    private void init() {
        ...
        fa.setOnClickListener(view -> {
            try {
                ...
                new DirectionFinder(MapActivity.this, origin, searchLocation.latitude + "," + searchLocation.longitude).execute(getString(R.string.google_api_key));
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            destinationMarker.add(map.addMarker(new MarkerOptions()
                    ...
                    .position(new LatLng(12.359,65.1))));
